...
make_player('#e0e0e0', 'assets/sprites/player_white.png')
make_player('#ffc107', 'assets/sprites/player_yellow.png')
...
make_bomb('assets/sprites/bomb_white.png', '#8a8a8a', '#cccccc')
make_bomb('assets/sprites/bomb_yellow.png', '#6a5a1a', '#ccaa22')
